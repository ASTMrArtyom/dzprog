...
class DipoleAntenna:
    ...
    def radiation_pattern(self, theta):
        """Расчет нормированной характеристики направленности F(θ)"""
...
def plot_results(antenna, theta_deg, D_theta, D_theta_db):
    ...
    # Создаем первую фигуру с декартовыми графиками
    ...
    # Создаем вторую фигуру с полярными графиками
    ...
    # Показываем оба окна одновременно
    plt.show()
